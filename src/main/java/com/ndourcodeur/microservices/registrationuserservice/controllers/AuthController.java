...
import com.ndourcodeur.microservices.registrationuserservice.payload.request.LoginRequest;
import com.ndourcodeur.microservices.registrationuserservice.payload.request.SignupRequest;
import com.ndourcodeur.microservices.registrationuserservice.payload.response.JwtResponse;
import com.ndourcodeur.microservices.registrationuserservice.repository.RoleRepository;
import com.ndourcodeur.microservices.registrationuserservice.repository.UserRepository;
import com.ndourcodeur.microservices.registrationuserservice.security.jwt.JwtUtils;
import com.ndourcodeur.microservices.registrationuserservice.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	/**
	 *
	 *    URL ===> http://localhost:8100/api/auth/login
	 */
	@PostMapping("/login")
	...
	/**
	 *
	 *    URL ===> http://localhost:8100/api/auth/registration
	 */
